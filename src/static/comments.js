window.onload = function() {
    ...
    if (!authToken) {
        window.location.href = 'admin.html'; // R
...
function fetchComments(authToken) {
    const apiUrl = 'https://peptabase-rpqb.shuttle.app/v1/admin/comment'; 
    fetch(apiUrl, {
        method: 'GET',
        headers: {
...
function deleteComment(commentId) {
    ...
    // Example:
    const apiUrl = `https://peptabase-rpqb.shuttle.app/v1/admin/deletecomment/${commentId}`;
    fetch(apiUrl, {
        method: 'DELETE',
        headers: {
